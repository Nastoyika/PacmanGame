...
public class GameBoard : MonoBehaviour
{
    ...
    public Text consumedGhostScoreText, ScoreTextBonus;
    ...
    public IEnumerator ProcessConsumedBonusItem(GameObject bonusItem, int scoreValue)
    {
        ...
        ScoreTextBonus.GetComponent<RectTransform>().anchorMin = viewPortPoint;
        ScoreTextBonus.GetComponent<RectTransform>().anchorMax = viewPortPoint;

        ScoreTextBonus.text = scoreValue.ToString();
        ScoreTextBonus.enabled = true;
        Destroy(bonusItem.gameObject);
        UpdateUI();
        yield return new WaitForSeconds(0.75f);

        ScoreTextBonus.enabled = false;
    }
